import './Ong.css'
import img6 from '../assets/bac.jpg'
...
function Ong() {
  ...
  <div className='main'>
    ...
    <div className='t-2'>Ong bac</div>
    <div className='t-3'>English .1h 40min</div>
    </div>
    <div className='middle'>
        <div className='m-t'>
    <div className='mt-1'>
        <button><img src={img7} alt="" className='l33' />6.2</button>
    </div>
    <div className='mt-2'>
    ...
    <div className='mt-4'>
        ...
        <div className='m-b'>
            ...
            <div className='mb-2'>A Viking prince seeks revenge</div>
        </div>
    </div>
            ...
            <div className='bb-l'>
             ...
             <div className='bb-r'>
                <div className='bbr-t'>
                    ...
                    <div className='bbrt-2'>English</div>
                </div>
                <div className='bbr-b'>
